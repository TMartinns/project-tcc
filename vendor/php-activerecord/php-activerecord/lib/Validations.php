...
class Validations
{
	...
	{
		$configuration = array_merge(self::$DEFAULT_VALIDATION_OPTIONS, array('message' => Errors::$DEFAULT_ERROR_MESSAGES['BlankController'], 'on' => 'save'));
...
class Errors implements IteratorAggregate
{
	...
	public static $DEFAULT_ERROR_MESSAGES = array(
		...
		'BlankController' => "can't be blank",
	...
	{
		if (!$msg)
			$msg = self::$DEFAULT_ERROR_MESSAGES['BlankController'];
