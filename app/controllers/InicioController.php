        ...
        foreach ($diligencias as $diligencia) {
            ...
            if ($diligencia->id_tipo_diligencia != $diligenciaUrgente->id) {
                ...
                if ($evento->id_autor == $this->auth->getUserId()) {
                    $prazoEsgotando = TipoNotificacao::find_by_tipo('Prazo Esgotando');
                    $prazoEsgotado = TipoNotificacao::find_by_tipo('Prazo Esgotado');
                    ...
                    if (empty(Notificacao::find_by_id_diligencia_and_id_destinatario_and_id_tipo_notificacao(
                        ...
                        $notificacao = array(
                            ...
                            'id_tipo_notificacao' => $prazoEsgotando->id
                        );
                        ...
                        $notificacao = array(
                            ...
                            'data' => date('Y-m-d H:i:s'),
                            'id_tipo_notificacao' => $prazoEsgotado->id
                        );
